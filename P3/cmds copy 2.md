...
# Create a bridge and add all connected physical interfaces and VXLAN to it
...
# Create a bridge and add local physical interface and VXLAN to it
ip link add name br0 type bridge
ip link set dev br0 up
...
# Create a bridge and add local physical interface (eth1) and VXLAN to it
ip link add name br0 type bridge
ip link set dev br0 up
